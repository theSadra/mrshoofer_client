  ...
  (
    {
      ...
      stepClassName,
      className,
      dir = "ltr", // Add this prop, default to "ltr"
      ...props
    },
    ref,
  ) => {
            ...
            return (
              <li key={stepIdx} className="relative flex w-full max-w-[120px] items-center">
                <button
                  ...
                  className={cn(
                    "group flex w-full cursor-pointer flex-col items-center justify-center gap-y-2 rounded-large py-2.5  h-full",
                    stepClassName,
                  )}
                  ...
                  <div className="h-ful relative flex items-center">
                    ...
                    {stepIdx < steps.length - 1 && !hideProgressBars && (
                      <div
                        aria-hidden="true"
                        className={cn(
                          "pointer-events-none absolute top-1/2 flex w-8 -translate-y-1/2 items-center sm:w-12",
                          dir === "rtl"
                            ? "right-5 md:right-3 -translate-x-1/2 -scale-x-100"
