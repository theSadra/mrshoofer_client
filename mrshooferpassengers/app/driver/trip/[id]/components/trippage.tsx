        ...
        <>
            <div>
                <p className="text-lg font-bold mb-6">
                    {trip.Driver?.Firstname} {trip.Driver?.Lastname} عزیز
                    خوش آمدید!
                </p>
            </div>
                ...
                <CardBody>
                    ...
                    <div>
                        <div className="flex justify-between mt-2">
                            <textarea
                                className="w-full text-sm text-default-700 bg-default-100 rounded-lg border border-default-200 p-2 resize-none"
                                rows={2}
                    ...
                    {trip.Location && typeof trip.Location.Latitude === 'number' && typeof trip.Location.Longitude === 'number' && (
                        ...
                        )} className="w-full mt-1 font-md" color="primary" variant="solid" onClick={onOpen} size="lg">
                            مسیریابی
                        </Button>
                    )}
