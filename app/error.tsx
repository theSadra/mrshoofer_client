...
export default function Error({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 bg-default-50 px-6 py-12 text-center">
      <div>
        <h2 className="text-2xl font-bold text-danger-500">خطای غیرمنتظره</h2>
        <p className="text-default-600 mt-2">
          درخواست شما با خطا مواجه شد. برای ادامه دوباره تلاش کنید یا با تیم پشتیبانی تماس بگیرید.
        </p>
      </div>
