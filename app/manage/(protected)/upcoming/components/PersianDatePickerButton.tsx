...
export default function PersianDatePickerButton({
  onDateSelected,
}: {
    ...
    <>
      ...
      >
        <span>
          ...
          >
            <path
              d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 16H5V9h14zm0-11H5V6h14zm-7 5h5v5h-5z"
              fill="currentColor"
            />
          </svg>
        </span>
