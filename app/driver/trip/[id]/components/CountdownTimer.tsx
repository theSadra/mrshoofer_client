...
const CountdownTimer: React.FC<CountdownTimerProps> = ({ target }) => {
    ...
    if (timeLeft <= 0) {
        return <span className="text-green-600 font-bold text-xl">سفر شروع شد!</span>;
    }
    ...
    return (
        <span className={`text-2xl font-bold text-primary-700 bg-purple-100 px-2 py-1 rounded-xl shadow flex items-center align-sub gap-3`}>
